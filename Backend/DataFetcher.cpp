...
//
//DataFetcher::DataFetcher(const std::string& apiKey, const std::string& symbol)
//    : apiKey(apiKey), symbol(symbol), movingAverage(10), running(false) {}
//
...
//}
//
//void DataFetcher::fetchAndCalculateMovingAverage() {
...
//    while (running) {
//        fetchAndCalculateMovingAverage();
...
//    server.Get("/moving_average", [this](const httplib::Request&, httplib::Response& res) {
//        res.set_header("Access-Control-Allow-Origin", "*");
//        res.set_header("Access-Control-Allow-Methods", "POST, OPTIONS");
//        res.set_header("Access-Control-Allow-Headers", "Content-Type");
//        double avg = movingAverage.getMovingAverage();
//        res.set_content(std::to_string(avg), "text/plain");
//        });
//
...
//using namespace std::chrono_literals;
//
//DataFetcher::DataFetcher(const std::string& apiKey, const std::string& symbol, MovingAverage& movingAverage)
//    : apiKey(apiKey), symbol(symbol), movingAverage(movingAverage), running(false) {}
//
//DataFetcher::~DataFetcher() {
//    running = false;
//}
...
//}
//
//void DataFetcher::fetchAndUpdateMovingAverage() {
//    std::string url = "https://finnhub.io/api/v1/quote?symbol=" + symbol + "&token=" + apiKey;
//    std::string response = performGetRequest(url);
//
//    auto jsonResponse = nlohmann::json::parse(response);
...
//        res.set_content(std::to_string(movingAverage.getMovingAverage()), "text/plain");
//        });
//
//    server.listen("0.0.0.0", 8080);
//}
...
//using namespace std::chrono_literals;
//
//DataFetcher::DataFetcher(const std::string& apiKey, const std::string& symbol, MovingAverage& movingAverage, Volatility& volatility, EMA& ema)
//    : apiKey(apiKey), symbol(symbol), movingAverage(movingAverage), volatility(volatility), ema(ema), running(false) {}
//
//DataFetcher::~DataFetcher() {
//    running = false;
//}
...
//    std::string response = performGetRequest(url);
//
//    movingAverage.addDataPoint(temp);
//    volatility.addDataPoint(temp);
//    ema.addDataPoint(temp);
//
//    temp += 20;
//
//    auto jsonResponse = nlohmann::json::parse(response);
